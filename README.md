...
Novella is a Godot 4 visual novel / GalGame plugin. The current implementation includes the v0.1 script runtime core, the v0.2 Alpha presentation core, the v0.3 Alpha interaction/state core, and the v0.4 Alpha editor authoring tools.
...
Not yet implemented: v0.5 localization/gallery/achievements and v1.0 release packaging polish.
